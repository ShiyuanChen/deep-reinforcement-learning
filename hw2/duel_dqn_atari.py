...
from deeprl_hw2.dueldqn import DuelDQNAgent
...
def create_model(window, input_shape, num_actions,
    ...
    # average dueling
    output = Lambda(lambda fc5: fc5[0] + (fc5[1] - K.mean(fc5[1])), output_shape=(num_actions,))([fc5_value, fc5_adv])
...
def main():  # noqa: D103
    ...
    parser.add_argument('--save', default='output/dueling_dqn', help='Directory to save model to')
    parser.add_argument('--seed', default=0, type=int, help='Random seed')
    parser.add_argument('--mode', choices=['train', 'test'], default='train')
    parser.add_argument('--load', default='output/dueling_dqn', help='Directory to load model from')
    ...
    dqn.compile(Adam(lr=.0002, clipnorm=10.), loss_func='mse')
